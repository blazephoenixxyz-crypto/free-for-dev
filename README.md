...
## APIs, Data, and ML
  ...
  * [BlazePhoenix](https://blazephoenix.xyz) - Free on-chain DEX aggregator API and Quoter service with OpenAPI support and MCP endpoint for AI agents. No API key required.
